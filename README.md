...
1. 카테고리 클릭 시에 카테고리의 변수와 일치하는지 확인을 위해 조건문 c:if를 사용한다.
2. 일치하는 경우, 해당 카테고리에 "active"클래스가 부여되고 해당 카테고리 코드가 포함된 숨겨진 입력 필드가 페이지에 보이게 된다.
3. 검색어를 입력하기 위한 텍스트 입력 필드와 검색 버튼으로, 검색 버튼을 클릭하면, 입력한 검색어와 선택한 카테고리 코드가 폼 데이터로 서버로 전송된다. 
---
...
## 6️⃣ Document
## 1.개발일정
<p align="center"><img src="https://res.cloudinary.com/dnik5jlzd/image/upload/v1678895431/readme/KakaoTalk_20230316_004946423.png"  width="400"><img src="https://res.cloudinary.com/dnik5jlzd/image/upload/v1678894850/readme/%EC%A0%9C%EB%AA%A9_%EC%97%86%EC%9D%8C24124.png"  width="400"></p>
