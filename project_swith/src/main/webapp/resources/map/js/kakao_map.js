...
$(function(){
	...
	function searchPlaces() {
	    ...
	    var keyword = document.getElementById('sido').value 
	    			+" "+ document.getElementById('sigungo').value 
	    			+ " 스터디 카페";
	...
	function displayPlaces(places) {
	    ...
	    var listEl = document.getElementById('destination_list'), 
