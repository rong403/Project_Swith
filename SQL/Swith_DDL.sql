...
CREATE TABLE "STUCY_CATEGORY" (
	"STUDY_CATEGORY_CODE"	NUMBER		NOT NULL,
	"STUDY_CATEGORY_NAME"	VARCHAR2(50)		NOT NULL
);
ALTER TABLE "STUCY_CATEGORY" ADD CONSTRAINT "PK_STUCY_CATEGORY" PRIMARY KEY (
	"STUDY_CATEGORY_CODE"
);
CREATE TABLE "STUDY" (
...
ALTER TABLE "USER_INFO" ADD CONSTRAINT "FK_M_AUTH_INFO_TO_U_INFO_1" FOREIGN KEY (
	"MEMBER_AUTH_CODE"
)
...
ALTER TABLE "STUDY" ADD CONSTRAINT "FK_STUCY_CATEGORY_TO_STUDY_1" FOREIGN KEY (
	"STUDY_CATEGORY_CODE"
)
REFERENCES "STUCY_CATEGORY" (
	"STUDY_CATEGORY_CODE"
);
