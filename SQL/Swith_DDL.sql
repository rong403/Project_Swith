...
CREATE TABLE "STUDY_ROOM" (
	...
	"ROOM_START_TIME"	VARCHAR2(10)		NOT NULL,
	"ROOM_END_TIME"	VARCHAR2(10)		NOT NULL,
...
CREATE TABLE "CARD_INFO" (
	"TIB"	VARCHAR2(20)		NOT NULL,
	"BIN"	VARCHAR2(6)		NOT NULL,
	"CARD_TYPE"	VARCHAR2(10)		NOT NULL,
	"KKP_PUR_CORP"	VARCHAR2(12)		NOT NULL,
	"KKP_PUR_CORP_CODE"	VARCHAR2(3)		NOT NULL,
	"KKP_ISS_CORP"	VARCHAR2(12)		NOT NULL,
	"RESERVE_START_TIME"	VARCHAR2(3)		NOT NULL
);
...
CREATE TABLE "RESERVE_INFO" (
	...
	"RESERVE_START_TIME"	VARCHAR2(10)		NOT NULL,
	"RESERVE_END_TIME"	 VARCHAR2(10)		NOT NULL,
