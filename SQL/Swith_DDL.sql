...
DROP TABLE "CANCEL_OfRESERVE_INFO";
...
DROP TABLE "MEMBER_AUTH_INFO";

CREATE TABLE "MEMBER_AUTH_INFO" (
	"MEMBER_AUTH_CODE"	NUMBER		NOT NULL,
	"MEMBER_AUTH_NAME"	VARCHAR2(20)		NOT NULL
);
...
CREATE TABLE "MEMBER_STATE" (
	"MEMBER_ID"	VARCHAR2(20)		NOT NULL,
	"MEMBER_STATUS"	NUMBER		NOT NULL,
	"RESERVE_PRICE"	DATE	DEFAULT SYSDATE	NOT NULL
);
CREATE TABLE "REPORT" (
...
CREATE TABLE "CANCEL_OfRESERVE_INFO" (
	"RESERVE_NO"	NUMBER		NOT NULL,
	"MEMBER_ID"	VARCHAR2(20)		NOT NULL,
	"ROOM_NO"	NUMBER		NOT NULL,
	"RESERVE_PRICE"	VARCHAR2(20)		NOT NULL,
...
/* PK 적용 */
ALTER TABLE "MEMBER_AUTH_INFO" ADD CONSTRAINT "PK_MEMBER_AUTH_INFO" PRIMARY KEY (
	"MEMBER_AUTH_CODE"
);
...
ALTER TABLE "PLACE_CODE" ADD CONSTRAINT "PK_PLACE_CODE" PRIMARY KEY (
	"SIGUNGU_CODE"
);
...
ALTER TABLE "CANCEL_OfRESERVE_INFO" ADD CONSTRAINT "PK_CANCEL_OFRESERVE_INFO" PRIMARY KEY (
	"RESERVE_NO"
);
...
/* FK 적용 */
ALTER TABLE "USER_INFO" ADD CONSTRAINT "FK_MEMBER_AUTH_TO_USER_1" FOREIGN KEY (
	"MEMBER_AUTH_CODE"
)
REFERENCES "MEMBER_AUTH_INFO" (
	"MEMBER_AUTH_CODE"
);

ALTER TABLE "MEMBER_STATE" ADD CONSTRAINT "FK_USER_INFO_TO_MEMBER_STATE_1" FOREIGN KEY (
	"MEMBER_ID"
)
...
ALTER TABLE "STUDY" ADD CONSTRAINT "FK_STUDY_AUTH_INFO_TO_STUDY_1" FOREIGN KEY (
	"AUTH_CODE"
)
...
ALTER TABLE "STUDY_COMMENT" ADD CONSTRAINT "FK_USER_INFO_TO_STU_COM_1" FOREIGN KEY (
	"MEMBER_ID"
)
REFERENCES "USER_INFO" (
	"MEMBER_ID"
...
ALTER TABLE "STUDY_RESERVER" ADD CONSTRAINT "FK_USER_INFO_TO_STU_RES_1" FOREIGN KEY (
	"MEMBER_ID"
)
REFERENCES "USER_INFO" (
	"MEMBER_ID"
...
ALTER TABLE "STUDY_PARTICIPANT" ADD CONSTRAINT "FK_USER_INFO_TO_STU_PART_1" FOREIGN KEY (
	"MEMBER_ID"
)
REFERENCES "USER_INFO" (
	"MEMBER_ID"
...
ALTER TABLE "STUDY_PARTICIPANT" ADD CONSTRAINT "FK_STUDY_TO_STU_PART_1" FOREIGN KEY (
	"STUDY_NO"
)
REFERENCES "STUDY" (
	"STUDY_NO"
...
ALTER TABLE "CHATTING" ADD CONSTRAINT "FK_STU_PART_TO_CHATTING_1" FOREIGN KEY (
	"AGR_NUMBER"
)
...
ALTER TABLE "BOARD_COMMENT" ADD CONSTRAINT "FK_USER_INFO_TO_BOARD_COM_1" FOREIGN KEY (
	"MEMBER_ID"
)
REFERENCES "USER_INFO" (
	"MEMBER_ID"
...
ALTER TABLE "RESERVE_INFO" ADD CONSTRAINT "FK_STUDY_ROOM_TO_RES_INFO_1" FOREIGN KEY (
	"ROOM_NO"
)
REFERENCES "STUDY_ROOM" (
	"ROOM_NO"
